...
# print("Gradient Test")
# fval, grad, hess =  compute_gmm_hessian(df,parameter_vector,W,X_dep=X,Z_dep=Z)
# print(grad)
#
# grad_test = numerical_gradient(df,parameter_vector,W,X_dep=X,Z_dep=Z)
# print(grad_test)
...
# print(hess)
#
# hess_test = numerical_hessian(df,parameter_vector,W,X_dep=X,Z_dep=Z)
# print(hess_test)
#
# print((hess-hess_test)/hess)
# print(np.mean((hess-hess_test)))
#
