...
for file in os.listdir(directory):
    ...
    if 'bhcf' == filename[:4]:
        ...
        try:
            temp = pd.read_csv(FRY9_location+filename,delimiter='^',skiprows=[1],dtype=object,error_bad_lines=False,na_values='--------')
        except UnicodeDecodeError:
            temp = pd.read_csv(FRY9_location+filename,delimiter='^',skiprows=[1],dtype=object,error_bad_lines=False,na_values='--------',encoding = 'unicode_escape')
